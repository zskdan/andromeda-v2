...
terms and exact hardware revision are recorded. The v0.1 FreeCAD source therefore
...
- Archive SHA-256 observed during the v0.1 study:
  `ba36c6c15f76f00fbc288600e2a902973c8033e9ddb986b12cd3ad9e291350fc`
- STEP SHA-256 observed during the v0.1 study:
...
The v0.1 model uses the published `77 x 60 x 10.9 mm` envelope. Add the exact
